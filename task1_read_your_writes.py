#!/usr/bin/env python3
"""
task1_read_your_writes.py

Client-centric consistency model: READ-YOUR-WRITES (RYW).
...
def main():
    ...
    _section("TASK 1: READ-YOUR-WRITES CONSISTENCY EXPERIMENT")
    ...
    logger = common.TrialLogger("task1_ryw")
    all_run_ids = []
    ...
    try:
        ...
        # normal operation, node failure, and a network partition. This
        # runs the exact same Config A / Config B pass under each of them.
